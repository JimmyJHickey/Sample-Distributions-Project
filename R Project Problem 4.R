...
hist(means10, main = paste("Histogram of z's with n = ", n[1], "From N( mu , sigma^2 )", sep = ""),xlab = "Means", prob = T)
lines(seq(from = -3, to =3, by = 0.01), dnorm(seq(from = -3, to = 3, by = 0.01)))

hist(means50, main = paste("Histogram of z's with n = ", n[2], "From N( mu ,sigma^2 )", sep = ""), xlab = "Means", prob = T)
lines(seq(from = -3, to =3, by = 0.01), dnorm(seq(from = -3, to = 3, by = 0.01)))
     
hist(means100, main = paste("Histogram of z's with n = ", n[3], "From N( mu , sigma^2 )", sep = ""), xlab = "Means", prob = T)
lines(seq(from = -3, to =3, by = 0.01), dnorm(seq(from = -3, to = 3, by = 0.01)))
          
hist(means250, main = paste("Histogram of z's with n = ", n[4], "From N( mu , sigma^2 )", sep = ""), xlab = "Means", prob = T)
lines(seq(from = -3, to =3, by = 0.01), dnorm(seq(from = -3, to = 3, by = 0.01)))
